...
public class FibonacciHeap {
    ...
    private int size;
    protected HeapNode start; //TODO rename this to a more indicative name.
    protected HeapNode minimum;
    ...
    protected static int numberOfCuts;

    private static int numberOfMarked;
    ...
    public void deleteMin() throws IllegalArgumentException {
        ...
        if (this.size == 1) {  //TODO change accordingly.
            this.start = null;
            this.minimum = null;
        } else {
            ...
            if (this.minimum.child != null) {
                HeapNode currentNode = this.minimum.child;
                do {
                    currentNode.parent = null;
                    if (currentNode.marked == true) {
                    	currentNode.marked = false;
                    	numberOfMarked -= 1;
                    }
                    currentNode = currentNode.next;
                } while (currentNode != this.minimum.child);
            }
        ...
        this.size--; //TODO should be at the end of this function (only if all the deletion process was successful..) 
    }
     ...
     * 
     * The function gets two HeapNode, find the one with minimal key and make
     * him the parent of the bigger one.
     */
    public HeapNode linkTrees(HeapNode node1, HeapNode node2) {
        numberOfLinks += 1;
    ...
    public void consolidate() {
        ...
        HeapNode nextNode = this.start;
        do {
            HeapNode linkTree = nextNode;
        ...
        } while (nextNode != this.start && nextNode.parent == null);
    }
     ...
     */
    public void decreaseKey(HeapNode nodeToDecrease, int delta)
        ...
        if (nodeToDecrease.parent != null
                && nodeToDecrease.key < nodeToDecrease.parent.key) {
